    ...
    <div class="container">
      ...
      <form class="main-form" method="POST" action="{{route('appointment')}}" >
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="doctor" id="doctors" class="form-select" aria-label="Doctor Information">
                <option value="" disabled selected>Select a doctor</option> <!-- Placeholder option -->
                {{-- AJAX will populate doctor options here --}}
            </select>
            @error('doctor')
        ...
        success: function (response) {
            ...
            $.each(response, function (key, value) {
              ...
              $doctors.append('<option value = "' +
                    value.name + '">' +
                    value.name + '---'+ value.qualification +'</option>');
